...
pub struct StunTurnConfig {
    ...
    pub max_port: u16,
    #[serde(default)]
    pub user_realm_map: Vec<(String, String)>,
...
fn default_turn_cert() -> PathBuf { PathBuf::from("/etc/turnserver/turn_cert.pem") }
fn default_turn_key() -> PathBuf { PathBuf::from("/etc/turnserver/turn_pkey.pem") }
fn default_min_port() -> u16 { 49152 }
fn default_max_port() -> u16 { 65535 }
fn default_turn_log() -> PathBuf { PathBuf::from("/var/log/turnserver.log") }
...
fn default_rustdesk_key() -> PathBuf { PathBuf::from("/root/rustdesk_key") }
fn default_rustdesk_db() -> PathBuf { PathBuf::from("/var/lib/rustdesk-server/db_v2.sqlite3") }
...
impl Default for Config {
    fn default() -> Self {
        let mut config_path = Self::find_config_path();
        Self {
            web_port: 9000,
